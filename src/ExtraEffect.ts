...
export const EE_ALIASES: Record<string, string[]> = {
	'Аха': ['ахи'],
	'Базовый урон': ['базового урона', 'базового физического урона', 'базового ветряного урона', 'базового ледяного урона'],
	'Базовый шанс': ['базового шанса'],
	'Блазар': ['блазара', 'блазаром'],
	'Боевой дух': ['боевого духа', 'боевым духом'],
	'Бонус-атака': ['бонус-атаки', 'бонус-атакой', 'бонус-атаку', 'бонус-атак', 'бонус-атаками'],
	'Веселье': ['увеселяется'],
	'Внезапная атака': ['внезапную атаку'],
	'Граница': ['границы'],
	'Дополнительный урон': ['дополнительный физический урон', 'дополнительный ледяной урон', 'доп. урон', 'доп. урона', 'дополнительный электрический урон', 'дополнительный огненный урон', 'дополнительный мнимый урон', 'дополнительный квантовый урон', 'дополнительным уроном', 'дополнительного урона'],
	'Дополнительный ход': ['дополнительного хода'],
	'Дрожь': ['дрожью', 'контратаку'],
	'Душа кокона / Душа бабочки': ['душа кокона', 'душу кокона', 'душа бабочки', 'души бабочки'],
	'Задержка действия': ['действие этого противника задерживается', 'задерживает её действие', 'задерживает его действие', 'задерживаются', 'действие противника задерживается', 'задержать действия'],
	'Златиусы': ['златиус', 'златиуса'],
	'Истинный урон': ['истинного урона', 'неистинного урона'],
	...
	'Мультистриминг': ['мультистриминга'],
	'Настоящий хит': ['Настоящего хита'],
	'Неспособность сражаться': ['неспособными сражаться', 'неспособны сражаться', 'неспособен сражаться', 'неспособна сражаться', 'становится неспособна сражаться', 'неспособным сражаться', 'неспособной сражаться'],
	'Ослабление': ['ослаблению', 'ослабления', 'ослаблений', 'ослаблениями', 'ослаблением', 'эффекта контроля'],
	'Ослабления контроля': ['эффектам контроля', 'эффекта контроля', 'эффекты контроля', 'эффект контроля', 'эффектов контроля', 'эффектом контроля'],
	'Отсутствие;': ['покидают поле боя'],
	'Распределение урона': ['передаёт', 'передача урона'],
	'Подкрепление': ['подкрепления'],
	'Подозрение': ['подозрением', 'подозрения'],
	'Послевкусие': ['послевкусием', 'послевкусия'],
	'Премиальная коробочка с сюрпризом': ['премиальной коробочки с сюрпризом'],
	'Призыв духа памяти': ['призывает духа памяти', 'призывается дух памяти', 'духа памяти'],
	...
	'Пробитие уязвимости': ['с пробитой уязвимостью', 'пробитой уязвимости', 'пробитую уязвимость', 'уязвимость цели', 'уязвимость цели не пробита', 'уязвимость цели пробита', 'пробитой уязвимостью'],
	'Продвижение действия': ['продвигает действие', 'продвигает следующее действие', 'продвигает его действие вперёд', 'продвигается вперёд', 'продвигаются вперёд', 'действие вперёд', 'продвигает', 'продвигает действие кастории вперёд', 'действие продвигается вперёд'],
	'Продолжительный эффект': ['продолжительных эффектов'],
	'Совместная атака': ['совместной атакой', 'совместную атаку', 'совместную атаку'],
	'Споры': ['спор', 'споре', 'спора', 'спору'],
	'Территория': ['территории', 'территорию', 'покидают поле боя'],
	'Унисон': ['унисона'],
	'Урон пробития': ['урона ледяного пробития', 'урона пробития'],
	'Урон Радости': ['урона радости'],
	'Урон суперпробития': ['урона суперпробития'],
	'Усиление': ['усиления', 'усилений'],
